# -*- coding: utf-8 -*-
"""Main Exceptions for fortunes library"""


from fortunes.core.loggers.logger_manager import LoggerManager
...
class CoreException(Exception):
    ...
    def __init__(self,
                 ...
                 log=None):
        """Raise an exception from any part of fortunes package"""
